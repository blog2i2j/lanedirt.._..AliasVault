 ...
 */
export function showSavePrompt(container: HTMLElement, options: SavePromptOptions): void {
  ...
  prompt.innerHTML = createPromptHTML(login);
 ...
 */
function createPromptHTML(login: CapturedLogin): string {
  ...
  return `
    <div class="av-save-prompt__content">
      ...
      <div class="av-save-prompt__text">
        <div class="av-save-prompt__title">Save to AliasVault?</div>
      ...
      <div class="av-save-prompt__actions">
        ...
        <button class="av-save-prompt__btn av-save-prompt__btn--dismiss" aria-label="Dismiss">
