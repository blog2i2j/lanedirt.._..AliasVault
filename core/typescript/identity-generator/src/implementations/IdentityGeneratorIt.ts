...
import lastNames from '../dictionaries/it/lastnames';

// Male firstnames by decade
import maleNames1950s from '../dictionaries/it/firstnames_male_1950_1959';
import maleNames1960s from '../dictionaries/it/firstnames_male_1960_1969';
import maleNames1970s from '../dictionaries/it/firstnames_male_1970_1979';
import maleNames1980s from '../dictionaries/it/firstnames_male_1980_1989';
import maleNames1990s from '../dictionaries/it/firstnames_male_1990_1999';
import maleNames2000s from '../dictionaries/it/firstnames_male_2000_2009';
import maleNames2010s from '../dictionaries/it/firstnames_male_2010_2019';

// Female firstnames by decade
import femaleNames1950s from '../dictionaries/it/firstnames_female_1950_1959';
import femaleNames1960s from '../dictionaries/it/firstnames_female_1960_1969';
import femaleNames1970s from '../dictionaries/it/firstnames_female_1970_1979';
import femaleNames1980s from '../dictionaries/it/firstnames_female_1980_1989';
import femaleNames1990s from '../dictionaries/it/firstnames_female_1990_1999';
import femaleNames2000s from '../dictionaries/it/firstnames_female_2000_2009';
import femaleNames2010s from '../dictionaries/it/firstnames_female_2010_2019';
 ...
 */
export class IdentityGeneratorIt extends IdentityGenerator {
  /**
   * Get the male first names (generic fallback - empty as we use decade-based).
   */
  protected getFirstNamesMaleJson(): string[] {
    // Return empty array as we're using decade-based approach for Italian
    return [];
  }
