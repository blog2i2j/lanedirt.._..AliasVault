...
export type ItemTypeIconKey = keyof typeof ItemTypeIconSvgs;

/**
 * Get SVG string for an item type icon.
 */
export function getItemTypeIconSvg(key: ItemTypeIconKey): string {
 ...
 */
export function getAllIconKeys(): ItemTypeIconKey[] {
  return Object.keys(ItemTypeIconSvgs) as ItemTypeIconKey[];
}
